...
def struct_generator(input_psf,input_pdb,seltext,caps,ftype='xyz',ofile='qm_coords',rem=None,charge=None,mult=None,mm=False,qmmm_mode=None,zerocharge=None,ext_coords=None,wat_thresh=None,params=None):
	'''
	...
	def xyz_janus(ext_mol=None,h2o_thresh=None):
		global charge_list
		global atom_types
		global tot_qm
		global h2o_seltext
		...
		try:
			...
			h2o_seltext = ' or (name H1 H2 OH2 and around %.1f protein)' % float(h2o_thresh)
	...
	if ftype == 'qchem':
		...
		if qmmm_mode == 'janus':
			...
			xyz_janus(ext_coords,h2o_thresh=wat_thresh)
